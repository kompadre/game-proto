 ...
 * @return {!proto.gameproto.v1.SessionRequest} The clone.
 */
proto.gameproto.v1.SessionRequest.prototype.cloneMessage = function() {
  return /** @type {!proto.gameproto.v1.SessionRequest} */ (jspb.Message.cloneMessage(this));
};
